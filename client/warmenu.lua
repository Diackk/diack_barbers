...
local function drawTitle()
	if menus[currentMenu] then
		...
		DrawSprite("menu_textures", "translate_bg_1a", x, y+0.033, menus[currentMenu].width, titleHeight, 0.8, 8, 8, 8, 255)
...
local function drawButton(text, subText)
	...
	if multiplier then
		...
		if subText then
			drawText(subText, menus[currentMenu].x - 0., y - buttonHeight / 2 + buttonTextYOffset, buttonFont, subTextColor, buttonScale, false, shadow, true)
		end
	end
end
...
function WarMenu.CreateMenu(id, title)
	...
	menus[id].titleFont = 3
	menus[id].titleColor = { r = 255, g = 255, b = 255, a = 255 }
	menus[id].titleBackgroundColor = { r = 15, g = 15, b = 15, a = 255 }
	menus[id].titleBackgroundSprite = nil

	menus[id].menuTextColor = { r = 150, g = 150, b = 150, a = 255 }
	menus[id].menuSubTextColor = { r = 189, g = 189, b = 189, a = 255 }
	menus[id].menuFocusTextColor = { r = 255, g = 255, b = 255, a = 255 }
	menus[id].menuFocusBackgroundColor = { r = 15, g = 15, b = 15, a = 255 }
	menus[id].menuBackgroundColor = { r = 15, g = 15, b = 15, a = 255 }
